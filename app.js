document.addEventListener("DOMContentLoaded", function() {
    const apiKey = "So46MwQsgfy9QjQ6vcPcTLBy3QISl2P8";
        ...
        data.forEach(hour => {
            ...
            forecastContent += `
                <div class="weather-box">
                    <img src="https://developer.accuweather.com/sites/default/files/${weatherIcon < 10 ? '0' + weatherIcon : weatherIcon}-s.png" alt="${iconPhrase}" />
    ...
    function displayFiveDaysForecast(forecasts) {
        let forecastContent = '<h2>Five Days Forecast</h2>';
        forecasts.forEach(day => {
            ...
            forecastContent += `
                <div class="weather-box">
                <img src="https://developer.accuweather.com/sites/default/files/${weatherIcon}-s.png" alt="${iconPhrase}" />
                    <p>Date: ${dayOfWeek}</p>
